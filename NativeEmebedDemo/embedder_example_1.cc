...
//   6 seconds passed
//
//int test123(int argc, char *argv[])
int test123(const char *platform_kernel_binary_path, const char *kernel_binary_path)
{
//    if (argc != 3) {
...
//    const char *platform_kernel_binary_path = "vm_platform_strong.dill";
//    const char *kernel_binary_path = "app.dill";
